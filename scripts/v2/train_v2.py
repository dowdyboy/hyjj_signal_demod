...
from hyjj.v2.dataset import HyjjDataset, HyjjAMRCWDataset
from hyjj.v2.model import BiLSTMModel, CNNFeatureExtractor, BiLSTMModel2
# from hyjj.v2.model2 import UNET_1D
...
parser.add_argument('--output-dir', type=str, default='./output_v2', help='out dir')
