...
from hyjj.v4.dataset import HyjjDataset, HyjjAMRCWFullDataset
from hyjj.v4.model import BiLSTMModel, CNNFeatureExtractor, BiLSTMModel2
...
parser.add_argument('--output-dir', type=str, default='./output_v4', help='out dir')
...
def build_data():
    ...
    train_ds = HyjjAMRCWFullDataset(train_base_ds, )
    train_dl = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, )
    val_ds = HyjjAMRCWFullDataset(val_base_ds, )
