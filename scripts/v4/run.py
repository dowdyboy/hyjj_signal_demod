...
from hyjj.v4.model import CNNFeatureExtractor, BiLSTMModel2
from hyjj.v4.dataset import process_nco_signal_infer
...
def main(to_pred_dir, result_save_path):
    ...
    # 初始化模型
    device = 'cuda'
    amr_model_path = 'output_v4/checkpoint/chk_best_amr_step_10_161992/model_0.pt'
    cw_model_path = 'output_v4/checkpoint/chk_best_cw_step_6_161992/model_0.pt'
