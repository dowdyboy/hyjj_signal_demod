...
from hyjj.v5.model import CNNFeatureExtractor, BiLSTMModel2
from hyjj.v5.dataset import process_nco_signal_infer, gen_amr_data_aug
...
def main(to_pred_dir, result_save_path):
    ...
    # 初始化模型
    device = 'cuda'
    amr_model_path = 'output_v5/checkpoint/chk_best_amr_step_78_1265/model_0.pt'
    cw_model_path = 'output_v5/checkpoint/chk_best_cw_step_96_1265/model_0.pt'
    use_sample_len = False
    sample_len = 1560
